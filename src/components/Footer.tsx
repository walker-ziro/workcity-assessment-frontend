        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              A comprehensive client and project management platform designed 
              for modern businesses. Streamline your workflow with our intuitive 
              and powerful tools.
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://github.com/walker-ziro/workcity-assessment-frontend" 
                target="_blank" 
              ...
              <a 
                href="mailto:contact@workcity.com" 
                className="text-gray-400 hover:text-blue-400 transition-colors"
                aria-label="Email"
              >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 Workcity Assessment. Built for demonstration purposes.
            </div>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>Made with ❤️ using Next.js, TypeScript & Tailwind CSS</span>
            </div>
          </div>
        </div>
      </div>
